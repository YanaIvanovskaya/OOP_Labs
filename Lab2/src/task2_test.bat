...
fc OUT "%__CD__%Task2/test/part_of_symbol/output.txt"  || goto err

::case 4 -> Symbols in any positions
java Task2.code.Main "&Cat &lt;says&gt; ;&&quot;Meow&quot;. M&amp;M&;apos;s&" > OUT || goto err
fc OUT "%__CD__%Task2/test/symbols_in_any_positions/output.txt"  || goto err

::case 3 -> Only symbols in string
java Task2.code.Main "&lt;&gt;&quot;&quot;&amp;&apos;" > OUT || goto err
fc OUT "%__CD__%Task2/test/text_contains_symbols_only/output.txt"  || goto err

::case 2 -> No symbols found
java Task2.code.Main "Cat says meow-meow" > OUT || goto err
fc OUT "%__CD__%Task2/test/no_symbols_found/output.txt"  || goto err

::case 1 -> All correct
java Task2.code.Main "Cat &lt;says&gt; &quot;Meow&quot;. M&amp;M&apos;s" > OUT || goto err
fc OUT "%__CD__%Task2/test/correct/output.txt"  || goto err

::case 0 -> Incorrect arguments
java Task2.code.Main > OUT || goto err
fc OUT "%__CD__%Task2/test/incorrect_argument/output.txt"  || goto err
