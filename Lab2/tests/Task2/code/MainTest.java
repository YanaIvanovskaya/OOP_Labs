...
class MainTest {
    ...
    void case_only_part_of_entity() {
        ...
        Assertions.assertEquals(Task2.htmlEncode(original), original);
    }
    ...
    void case_special_symbols_in_any_positions() {
        ...
        Assertions.assertEquals(Task2.htmlEncode(original), expected);
    }
    ...
    void case_string_empty() {
        Assertions.assertEquals(Task2.htmlEncode(""), "");
    }
    ...
    void case_string_is_null() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> Task2.htmlEncode(null));
    }
